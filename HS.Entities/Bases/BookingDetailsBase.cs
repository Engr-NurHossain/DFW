...
{
	[Serializable]
    [DataContract(Name = "BookingDetailsBase", Namespace = "http://www.piistech.com//entities")]
	public class BookingDetailsBase : BaseBusinessEntity
	{
		...
		public  BookingDetailsBase Clone()
		{
			BookingDetailsBase newObj = new  BookingDetailsBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(BookingDetailsBase.Property_Id, Id);				
			info.AddValue(BookingDetailsBase.Property_CompanyId, CompanyId);				
			info.AddValue(BookingDetailsBase.Property_BookingId, BookingId);				
			info.AddValue(BookingDetailsBase.Property_RugType, RugType);				
			info.AddValue(BookingDetailsBase.Property_Length, Length);				
			info.AddValue(BookingDetailsBase.Property_LengthInch, LengthInch);				
			info.AddValue(BookingDetailsBase.Property_Width, Width);				
			info.AddValue(BookingDetailsBase.Property_WidthInch, WidthInch);				
			info.AddValue(BookingDetailsBase.Property_Radius, Radius);				
			info.AddValue(BookingDetailsBase.Property_RadiusInch, RadiusInch);				
			info.AddValue(BookingDetailsBase.Property_TotalSize, TotalSize);				
			info.AddValue(BookingDetailsBase.Property_Package, Package);				
			info.AddValue(BookingDetailsBase.Property_Included, Included);				
			info.AddValue(BookingDetailsBase.Property_Extras, Extras);				
			info.AddValue(BookingDetailsBase.Property_UnitPrice, UnitPrice);				
			info.AddValue(BookingDetailsBase.Property_DiscountType, DiscountType);				
			info.AddValue(BookingDetailsBase.Property_TaxType, TaxType);				
			info.AddValue(BookingDetailsBase.Property_Quantity, Quantity);				
			info.AddValue(BookingDetailsBase.Property_Discount, Discount);				
			info.AddValue(BookingDetailsBase.Property_TotalPrice, TotalPrice);				
			info.AddValue(BookingDetailsBase.Property_AddedDate, AddedDate);				
			info.AddValue(BookingDetailsBase.Property_AddedBy, AddedBy);				
			info.AddValue(BookingDetailsBase.Property_RugConditions, RugConditions);				
		}
		#endregion
