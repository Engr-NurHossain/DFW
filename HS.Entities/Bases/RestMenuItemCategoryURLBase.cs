...
{
	[Serializable]
    [DataContract(Name = "RestMenuItemCategoryURLBase", Namespace = "http://www.hims-tech.com//entities")]
	public class RestMenuItemCategoryURLBase : BaseBusinessEntity
	{
		...
		public  RestMenuItemCategoryURLBase Clone()
		{
			RestMenuItemCategoryURLBase newObj = new  RestMenuItemCategoryURLBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(RestMenuItemCategoryURLBase.Property_Id, Id);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_MenuId, MenuId);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_MenuItemId, MenuItemId);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_MenuCategoryURL, MenuCategoryURL);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_ItemCategoryURL, ItemCategoryURL);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(RestMenuItemCategoryURLBase.Property_CreatedBy, CreatedBy);				
		}
		#endregion
