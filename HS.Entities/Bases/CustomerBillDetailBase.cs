...
{
	[Serializable]
    [DataContract(Name = "CustomerBillDetailBase", Namespace = "http://www.piistech.com//entities")]
	public class CustomerBillDetailBase : BaseBusinessEntity
	{
		...
		public  CustomerBillDetailBase Clone()
		{
			CustomerBillDetailBase newObj = new  CustomerBillDetailBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(CustomerBillDetailBase.Property_Id, Id);				
			info.AddValue(CustomerBillDetailBase.Property_CustomerBillId, CustomerBillId);				
			info.AddValue(CustomerBillDetailBase.Property_EquipmentId, EquipmentId);				
			info.AddValue(CustomerBillDetailBase.Property_AccoutTypeId, AccoutTypeId);				
			info.AddValue(CustomerBillDetailBase.Property_Dscription, Dscription);				
			info.AddValue(CustomerBillDetailBase.Property_Quantity, Quantity);				
			info.AddValue(CustomerBillDetailBase.Property_Rate, Rate);				
			info.AddValue(CustomerBillDetailBase.Property_Amount, Amount);				
		}
		#endregion
