...
{
	[Serializable]
    [DataContract(Name = "ServiceCallCommissionBase", Namespace = "http://www.piistech.com//entities")]
	public class ServiceCallCommissionBase : BaseBusinessEntity
	{
		...
		public const string Property_ServiceCallCommissionId = "ServiceCallCommissionId";		            
		...
		private Int32 _Id;	            
		private Guid _ServiceCallCommissionId;	            
		...
		[DataMember]
		public Guid ServiceCallCommissionId
		{	
			get{ return _ServiceCallCommissionId; }			
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_ServiceCallCommissionId, value, _ServiceCallCommissionId);
				if (PropertyChanging(args))
				{
					_ServiceCallCommissionId = value;
					PropertyChanged(args);					
				}	
			}
        }
		...
		public  ServiceCallCommissionBase Clone()
		{
			ServiceCallCommissionBase newObj = new  ServiceCallCommissionBase();
			base.CloneBase(newObj);
			newObj.Id = this.Id;						
			newObj.ServiceCallCommissionId = this.ServiceCallCommissionId;						
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(ServiceCallCommissionBase.Property_Id, Id);				
			info.AddValue(ServiceCallCommissionBase.Property_ServiceCallCommissionId, ServiceCallCommissionId);				
			info.AddValue(ServiceCallCommissionBase.Property_TicketId, TicketId);				
			info.AddValue(ServiceCallCommissionBase.Property_CustomerId, CustomerId);				
			info.AddValue(ServiceCallCommissionBase.Property_UserId, UserId);				
			info.AddValue(ServiceCallCommissionBase.Property_CompletionDate, CompletionDate);				
			info.AddValue(ServiceCallCommissionBase.Property_Adjustment, Adjustment);				
			info.AddValue(ServiceCallCommissionBase.Property_Commission, Commission);				
			info.AddValue(ServiceCallCommissionBase.Property_IsPaid, IsPaid);				
			info.AddValue(ServiceCallCommissionBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(ServiceCallCommissionBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(ServiceCallCommissionBase.Property_Batch, Batch);				
			info.AddValue(ServiceCallCommissionBase.Property_CommissionCalculation, CommissionCalculation);				
			info.AddValue(ServiceCallCommissionBase.Property_PaidDate, PaidDate);				
			info.AddValue(ServiceCallCommissionBase.Property_IsManual, IsManual);				
		}
		#endregion
