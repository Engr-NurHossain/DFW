...
{
	[Serializable]
    [DataContract(Name = "RescheduleCommissionBase", Namespace = "http://www.piistech.com//entities")]
	public class RescheduleCommissionBase : BaseBusinessEntity
	{
		...
		public const string Property_RescheduleCommissionId = "RescheduleCommissionId";		            
		...
		private Int32 _Id;	            
		private Guid _RescheduleCommissionId;	            
		...
		[DataMember]
		public Guid RescheduleCommissionId
		{	
			get{ return _RescheduleCommissionId; }			
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_RescheduleCommissionId, value, _RescheduleCommissionId);
				if (PropertyChanging(args))
				{
					_RescheduleCommissionId = value;
					PropertyChanged(args);					
				}	
			}
        }
		...
		public  RescheduleCommissionBase Clone()
		{
			RescheduleCommissionBase newObj = new  RescheduleCommissionBase();
			base.CloneBase(newObj);
			newObj.Id = this.Id;						
			newObj.RescheduleCommissionId = this.RescheduleCommissionId;						
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(RescheduleCommissionBase.Property_Id, Id);				
			info.AddValue(RescheduleCommissionBase.Property_RescheduleCommissionId, RescheduleCommissionId);				
			info.AddValue(RescheduleCommissionBase.Property_TicketId, TicketId);				
			info.AddValue(RescheduleCommissionBase.Property_CustomerId, CustomerId);				
			info.AddValue(RescheduleCommissionBase.Property_UserId, UserId);				
			info.AddValue(RescheduleCommissionBase.Property_CompletionDate, CompletionDate);				
			info.AddValue(RescheduleCommissionBase.Property_Adjustment, Adjustment);				
			info.AddValue(RescheduleCommissionBase.Property_Commission, Commission);				
			info.AddValue(RescheduleCommissionBase.Property_IsPaid, IsPaid);				
			info.AddValue(RescheduleCommissionBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(RescheduleCommissionBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(RescheduleCommissionBase.Property_Batch, Batch);				
			info.AddValue(RescheduleCommissionBase.Property_CommissionCalculation, CommissionCalculation);				
			info.AddValue(RescheduleCommissionBase.Property_PaidDate, PaidDate);				
			info.AddValue(RescheduleCommissionBase.Property_IsManual, IsManual);				
		}
		#endregion
