...
{
	[Serializable]
    [DataContract(Name = "SupplierFileBase", Namespace = "http://www.piistech.com//entities")]
	public class SupplierFileBase : BaseBusinessEntity
	{
		...
		public  SupplierFileBase Clone()
		{
			SupplierFileBase newObj = new  SupplierFileBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(SupplierFileBase.Property_Id, Id);				
			info.AddValue(SupplierFileBase.Property_FileDescription, FileDescription);				
			info.AddValue(SupplierFileBase.Property_Filename, Filename);				
			info.AddValue(SupplierFileBase.Property_FileFullName, FileFullName);				
			info.AddValue(SupplierFileBase.Property_Uploadeddate, Uploadeddate);				
			info.AddValue(SupplierFileBase.Property_SupplierId, SupplierId);				
			info.AddValue(SupplierFileBase.Property_CompanyId, CompanyId);				
			info.AddValue(SupplierFileBase.Property_IsActive, IsActive);				
			info.AddValue(SupplierFileBase.Property_FileSize, FileSize);				
		}
		#endregion
