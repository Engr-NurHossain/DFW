...
{
	[Serializable]
    [DataContract(Name = "BookingExtraItemBase", Namespace = "http://www.piistech.com//entities")]
	public class BookingExtraItemBase : BaseBusinessEntity
	{
		...
		public  BookingExtraItemBase Clone()
		{
			BookingExtraItemBase newObj = new  BookingExtraItemBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(BookingExtraItemBase.Property_Id, Id);				
			info.AddValue(BookingExtraItemBase.Property_BookingId, BookingId);				
			info.AddValue(BookingExtraItemBase.Property_EquipmentId, EquipmentId);				
			info.AddValue(BookingExtraItemBase.Property_EquipName, EquipName);				
			info.AddValue(BookingExtraItemBase.Property_EquipDetail, EquipDetail);				
			info.AddValue(BookingExtraItemBase.Property_Quantity, Quantity);				
			info.AddValue(BookingExtraItemBase.Property_UnitPrice, UnitPrice);				
			info.AddValue(BookingExtraItemBase.Property_Discount, Discount);				
			info.AddValue(BookingExtraItemBase.Property_TotalPrice, TotalPrice);				
			info.AddValue(BookingExtraItemBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(BookingExtraItemBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(BookingExtraItemBase.Property_Taxable, Taxable);				
		}
		#endregion
