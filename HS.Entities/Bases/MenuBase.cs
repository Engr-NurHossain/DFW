...
{
	[Serializable]
    [DataContract(Name = "MenuBase", Namespace = "http://www.hims-tech.com//entities")]
	public class MenuBase : BaseBusinessEntity
	{
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(MenuBase.Property_Id, Id);				
			info.AddValue(MenuBase.Property_CompanyId, CompanyId);				
			info.AddValue(MenuBase.Property_MenuId, MenuId);				
			info.AddValue(MenuBase.Property_MenuName, MenuName);				
			info.AddValue(MenuBase.Property_Status, Status);				
			info.AddValue(MenuBase.Property_TimeAvailable, TimeAvailable);				
			info.AddValue(MenuBase.Property_DaysAvailable, DaysAvailable);				
			info.AddValue(MenuBase.Property_Description, Description);				
			info.AddValue(MenuBase.Property_Photo, Photo);				
			info.AddValue(MenuBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(MenuBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(MenuBase.Property_LastUpdatedBy, LastUpdatedBy);				
			info.AddValue(MenuBase.Property_LastUpdatedDate, LastUpdatedDate);				
			info.AddValue(MenuBase.Property_DaysAvailableOption, DaysAvailableOption);				
			info.AddValue(MenuBase.Property_TimeAvailableOption, TimeAvailableOption);				
			info.AddValue(MenuBase.Property_UrlSlug, UrlSlug);				
			info.AddValue(MenuBase.Property_WebsiteURL, WebsiteURL);				
			info.AddValue(MenuBase.Property_MetaTitle, MetaTitle);				
			info.AddValue(MenuBase.Property_MetaDescription, MetaDescription);				
		}
		#endregion
