...
{
	[Serializable]
    [DataContract(Name = "AddMemberCommissionBase", Namespace = "http://www.hims-tech.com//entities")]
	public class AddMemberCommissionBase : BaseBusinessEntity
	{
		...
		public const string Property_AddMemberCommissionId = "AddMemberCommissionId";		            
		...
		private Int32 _Id;	            
		private Guid _AddMemberCommissionId;	            
		...
		[DataMember]
		public Guid AddMemberCommissionId
		{	
			get{ return _AddMemberCommissionId; }			
			set
			{
				PropertyChangingEventArgs args = new PropertyChangingEventArgs(Property_AddMemberCommissionId, value, _AddMemberCommissionId);
				if (PropertyChanging(args))
				{
					_AddMemberCommissionId = value;
					PropertyChanged(args);					
				}	
			}
        }
		...
		public  AddMemberCommissionBase Clone()
		{
			AddMemberCommissionBase newObj = new  AddMemberCommissionBase();
			base.CloneBase(newObj);
			newObj.Id = this.Id;						
			newObj.AddMemberCommissionId = this.AddMemberCommissionId;						
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(AddMemberCommissionBase.Property_Id, Id);				
			info.AddValue(AddMemberCommissionBase.Property_AddMemberCommissionId, AddMemberCommissionId);				
			info.AddValue(AddMemberCommissionBase.Property_TicketId, TicketId);				
			info.AddValue(AddMemberCommissionBase.Property_CustomerId, CustomerId);				
			info.AddValue(AddMemberCommissionBase.Property_UserId, UserId);				
			info.AddValue(AddMemberCommissionBase.Property_CompletionDate, CompletionDate);				
			info.AddValue(AddMemberCommissionBase.Property_Adjustment, Adjustment);				
			info.AddValue(AddMemberCommissionBase.Property_Commission, Commission);				
			info.AddValue(AddMemberCommissionBase.Property_IsPaid, IsPaid);				
			info.AddValue(AddMemberCommissionBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(AddMemberCommissionBase.Property_CreatedDate, CreatedDate);				
			info.AddValue(AddMemberCommissionBase.Property_Batch, Batch);				
			info.AddValue(AddMemberCommissionBase.Property_CommissionCalculation, CommissionCalculation);				
			info.AddValue(AddMemberCommissionBase.Property_PaidDate, PaidDate);				
			info.AddValue(AddMemberCommissionBase.Property_IsManual, IsManual);				
			info.AddValue(AddMemberCommissionBase.Property_OriginalPoint, OriginalPoint);				
			info.AddValue(AddMemberCommissionBase.Property_AdjustablePoint, AdjustablePoint);				
			info.AddValue(AddMemberCommissionBase.Property_TotalPoint, TotalPoint);				
		}
		#endregion
