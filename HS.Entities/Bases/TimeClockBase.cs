...
{
	[Serializable]
    [DataContract(Name = "TimeClockBase", Namespace = "http://www.piistech.com//entities")]
	public class TimeClockBase : BaseBusinessEntity
	{
		...
		public  TimeClockBase Clone()
		{
			TimeClockBase newObj = new  TimeClockBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(TimeClockBase.Property_Id, Id);				
			info.AddValue(TimeClockBase.Property_UserId, UserId);				
			info.AddValue(TimeClockBase.Property_Time, Time);				
			info.AddValue(TimeClockBase.Property_Type, Type);				
			info.AddValue(TimeClockBase.Property_Lat, Lat);				
			info.AddValue(TimeClockBase.Property_Lng, Lng);				
			info.AddValue(TimeClockBase.Property_Note, Note);				
			info.AddValue(TimeClockBase.Property_CreatedBy, CreatedBy);				
			info.AddValue(TimeClockBase.Property_ClockedInMinutes, ClockedInMinutes);				
			info.AddValue(TimeClockBase.Property_LastUpdateBy, LastUpdateBy);				
			info.AddValue(TimeClockBase.Property_LastUpdatedDate, LastUpdatedDate);				
		}
		#endregion
