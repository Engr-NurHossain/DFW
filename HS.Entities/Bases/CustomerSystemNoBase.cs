...
{
	[Serializable]
    [DataContract(Name = "CustomerSystemNoBase", Namespace = "http://www.piistech.com//entities")]
	public class CustomerSystemNoBase : BaseBusinessEntity
	{
		...
		public  CustomerSystemNoBase Clone()
		{
			CustomerSystemNoBase newObj = new  CustomerSystemNoBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(CustomerSystemNoBase.Property_Id, Id);				
			info.AddValue(CustomerSystemNoBase.Property_CompanyId, CompanyId);				
			info.AddValue(CustomerSystemNoBase.Property_CustomerNo, CustomerNo);				
			info.AddValue(CustomerSystemNoBase.Property_IsUsed, IsUsed);				
			info.AddValue(CustomerSystemNoBase.Property_IsReserved, IsReserved);				
			info.AddValue(CustomerSystemNoBase.Property_GenerateDate, GenerateDate);				
			info.AddValue(CustomerSystemNoBase.Property_ReserveDate, ReserveDate);				
			info.AddValue(CustomerSystemNoBase.Property_UsedDate, UsedDate);				
			info.AddValue(CustomerSystemNoBase.Property_CustomerId, CustomerId);				
		}
		#endregion
