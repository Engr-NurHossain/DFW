...
{
	[Serializable]
    [DataContract(Name = "KnowledgebaseWeblinkBase", Namespace = "http://www.hims-tech.com//entities")]
	public class KnowledgebaseWeblinkBase : BaseBusinessEntity
	{
		...
		public  KnowledgebaseWeblinkBase Clone()
		{
			KnowledgebaseWeblinkBase newObj = new  KnowledgebaseWeblinkBase();
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			info.AddValue(KnowledgebaseWeblinkBase.Property_Id, Id);				
			info.AddValue(KnowledgebaseWeblinkBase.Property_KnowledgebaseId, KnowledgebaseId);				
			info.AddValue(KnowledgebaseWeblinkBase.Property_Title, Title);				
			info.AddValue(KnowledgebaseWeblinkBase.Property_Link, Link);				
			info.AddValue(KnowledgebaseWeblinkBase.Property_IsRelated, IsRelated);				
		}
		#endregion
