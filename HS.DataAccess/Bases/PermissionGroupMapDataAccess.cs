...
namespace HS.DataAccess
{
	public partial class PermissionGroupMapDataAccess : BaseDataAccess
	{
		...
		{	
			...
			AddParameter(cmd, pGuid(PermissionGroupMapBase.Property_CompanyId, permissionGroupMapObject.CompanyId));
		}
		#endregion
		...
		protected void FillObject(PermissionGroupMapBase permissionGroupMapObject, SqlDataReader reader, int start)
		{
				...
				permissionGroupMapObject.CompanyId = reader.GetGuid( start + 4 );			
			FillBaseObject(permissionGroupMapObject, reader, (start + 5));
