...
{
	public partial class RescheduleCommissionDataAccess
	{
        public DataTable GetRescheduleCommissionByTicketId(Guid ticketId, Guid CommissionUserId)
        {
            string subQUery = "";
            string sqlQuery = @"select 
                                ...
                                sc.Commission,
                                sc.RescheduleCommissionId,
                                sc.Adjustment
                                from RescheduleCommission sc
        ...
        {
            string SqlQuery = @"delete from RescheduleCommission where TicketId ='{0}'";
