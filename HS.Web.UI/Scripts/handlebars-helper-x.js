  ...
  Handlebars.registerHelper('coverHeight', function () {
      if (typeof (ImageHolder.Height) != "undefined") {
          return ImageHolder.Height;
      } else {
          return 245;
      }
  });
  Handlebars.registerHelper('coverWidth', function () {
      if (typeof (ImageHolder.Width) != "undefined") {
          return ImageHolder.Width;
      } else {
          return 298;
      }
  });
  Handlebars.registerHelper('agencyLogoCheck', function (LogoCheck) {
      if (typeof (LogoCheck) != undefined) {
          if (LogoCheck.toLowerCase() == "/content/icons/agencydefaultimage.png") {
              return "/Content/logo/Agency-notreg.png";
          } else {
              return LogoCheck;
          }
      }
  });
  Handlebars.registerHelper('replaceSpecialChar', function (Value) {
      var ValueClean = "";
      if (Value != undefined && Value != "") {
          ValueClean = Value.replace(/[. @ & : / ']/g, '-')
      }
      return ValueClean;
  });
