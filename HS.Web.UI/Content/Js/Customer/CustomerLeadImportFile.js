...
var SaveCustomerFile = function (isCustomer) {
    var url = domainurl + "/Leads/SaveCustomerLeadImportFile/";

    if ($("#IsADSAgemniCustomerImport").is(":checked")) {
        url = domainurl + "/ADS/ADSAgemniCustomerImport/";
    }
    else if ($("#IsADSImportFile").is(":checked")) {
        url = domainurl + "/ADS/CustomerImport/?PlatForm=ADS-Tier32";
    }
    else if ($("#IsDirectConnectCustomerImport").is(":checked")) {
        url = domainurl + "/ADS/CustomerImport/?PlatForm=DirectProtect-Tier32";
    }
    else if ($("#IsADSBillingFile").is(":checked")) {
        url = domainurl + "/ADS/ADSBillingImport/";
    }
    else if ($("#IsADSCasesFile").is(":checked")) {
        url = domainurl + "/ADS/ADSCasesImport/";
    }
    else if ($("#IsPointTier32CasesFile").is(":checked")) {
        url = domainurl + "/ADS/PointTier32CasesImport/";
    }
    else if ($("#IsPointTier32NotesFile").is(":checked")) {
        url = domainurl + "/ADS/PointTier32NotesImport/";
    }
    else if ($("#IsPointTier32CustomerNotesFile").is(":checked")) {
        url = domainurl + "/ADS/CustomerNoteImport/";
    }
    else if ($("#SyncDallasCustomer").is(":checked")) {
        url = domainurl + "/ADS/SyncDallasCustomer/";
    }
...
$(document).ready(function () {
    ...
    $('#UploadedFile').fileupload({
        pasteZone: null,
        url: domainurl + '/File/UploadCustomerLeadImportFile',
        dataType: 'json',
        add: function (e, data) {
