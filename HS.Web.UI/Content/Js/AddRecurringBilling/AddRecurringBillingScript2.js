...
var SaveRecurringBilling = function () {
    ...
    var param = JSON.stringify({
        ...
        "Schedule.IsReplacement": $("#e-Replacement").prop("checked"),
        "Schedule.IsTransfer": $("#e-Transfer").prop("checked"),
        "Schedule.IsFCReplacement": $("#e-FCReplacement").prop("checked"),
        "Schedule.IsPOO": $("#e-POO").prop("checked"),
