...
var InitialViewLoad = function () {
    ...
    var PaymentMethod = AddLeadPaymentMethod;
...
var DeleteLeadPaymentMethod = function (id, paymentinfoCusId) {
    var url = domainurl + "/Leads/DeleteLeadPaymentInfo";
    var param = JSON.stringify({
        CustomerId: $("#LeadContractCustomerID").val(),
        PaymentInfoId: id,
        paymentinfoCusId: paymentinfoCusId
    });
    $.ajax({
        type: "POST",
...
$(document).ready(function () {
    ...
    $(".PaymentMethodType").click(function () {
        var PaymentMethodType = $(this).attr("data-type");
        AddLeadPaymentMethod = PaymentMethodType;
        $(".mmr_payment_method_detils").show();
