var IsLead = true;
//var EstimatorList = function (Part_Desc, EstimatorId, Category, Supplier, Unit, Qty, Profit, Overhead, Unit_Cost, Total_Cost, Total_Price, startdate, enddate, SearchText, estimateStatus) {
...
var EstimatorList = function (EstimatorId, startdate, enddate, estimateStatus, SearchText) {
    ...
    if (IsLead == true) {
        $(".loadestimatorlist").load("/Estimator/EstimatorListPartial/?CustomerId=" + CustomerLoadId + "&SearchText=" + SearchText + "&StrStartDate=" + startdates + "&StrEndDate=" + enddates + "&estimateStatus=" + estimateStatus);
    }
    else {
        $(LoadCustomerDiv + ".loadestimatorlist").load("/Estimator/EstimatorListPartial/?CustomerId=" + CustomerLoadId + "&SearchText=" + SearchText + "&StrStartDate=" + startdates + "&StrEndDate=" + enddates + "&estimateStatus=" + estimateStatus);
    }
